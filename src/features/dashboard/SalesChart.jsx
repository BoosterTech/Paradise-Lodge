...
SalesChart.propTypes = {
  bookings: PropTypes.arrayOf(
    PropTypes.shape({
      created_at: PropTypes.string, // booking's creation date (string)
      totalPrice: PropTypes.number, // total price for the booking (number)
      extrasPrice: PropTypes.number, // extras price for the booking (number)
    })
  ), // bookings should be an array of booking objects
  numDays: PropTypes.number, // numDays should be a number
};
